...
async def stored_data(
    ...
    await update_chunk_view.broker.push_new_event_with(pixel=pixel2_2)
...
async def test_chunk_views(
    ...
    excepted_views = {chunk: CollectionChunkView([pixel1_2, pixel2_2])}
